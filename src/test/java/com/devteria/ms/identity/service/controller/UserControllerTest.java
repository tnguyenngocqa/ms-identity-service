...
public class UserControllerTest {
    ...
    @Test
    void test_CreateUser_validRequest_success() throws Exception {
        // GIVEN
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("result.id").value("795c3f5b-f3cc-4c58-91cf-557c3fca27ce"));
    }

    @Test
    void test_CreateUser_invalidUsername_fail() throws Exception {
        // GIVEN
